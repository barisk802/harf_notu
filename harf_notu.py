...
st.write("Vize 1, Vize 2 ve Final notunuzu giriniz:")

# Kullanıcıdan girişleri al
vize1 = st.number_input("Vize 1:", min_value=0, max_value=100, step=1)
vize2 = st.number_input("Vize 2:", min_value=0, max_value=100, step=1)
final = st.number_input("Final:", min_value=0, max_value=100, step=1)

# Hesapla butonu
if st.button("Hesapla"):
    genel_not = vize1 * 3/10 + vize2 * 3/10 + final * 7/10
